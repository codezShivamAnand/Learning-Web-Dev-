...
// we need three things to create a question 
//  1: storing a Question 
//  2: storing Options using Array
//  3: Answer

// obj1 = {
//     question: "who is god of cricket?";
//     option: ["Sachin Tendulkar", "Virat Kohli", "Rohit Sharma", "MS Dhoni"];
//     answer: "Sachin Tendulkar"
// }

// obj2 = { } ...till.. obj20 = { };

// storing all the objects in an array
...
// const quiz = [obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11, obj12, obj13, obj14, obj15, obj16, obj17, obj18, obj19, obj20];

function RandomQuestion(){
   
   // ek index ek baar hi select hona hai
...
// convert set into array, using spread operator
   return [...data]; // return in the form of array 
}

// selesct the form and insert all the elments into it 
const form = document.querySelector('form');
const problem = RandomQuestion();  // 5 random question selected 

const original_answer = {}; // key value pair
/*
1. <div class="question">
2.    <p> 1. who is the god of cricket </p>
3.    <label>
        <input>
        <textNode>
    </label>
...
problem.forEach((obj, index)=>{ // 5 baar run hoga 
    ...
    //1. div class question ko banana hai 
    const div_element = document.createElement('div');
    div_element.className = "question";
    original_answer[`q${index+1}`]= obj['answer'];

    
    //2. paragraph create karo 
    const para = document.createElement('p');
    para.textContent = `${index+1}. ${obj['question']}`; // or obj['question'] 
    div_element.appendChild(para);

    
    // options create karna hai 
    //3. label 
    obj['options'].forEach((opt)=>{
    //  ["Sachin Tendulkar", "Virat Kohli", "Ricky Ponting", "Jacques Kallis"], answer: "Sachin Tendulkar" },
    //    these are opt 
        const label = document.createElement('label'); // <label></label>
        const input = document.createElement('input'); // <input>
        input.type = "radio"; // <input type="radio">
        input.name = `q${index+1}`; // <input type="radio" name="q1">
        input.value = opt; // <input type="radio" name="q1" value="Sachin Tendulkar">
