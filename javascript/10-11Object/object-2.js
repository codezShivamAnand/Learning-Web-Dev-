...
let obj2 = obj1; // reference copy i.e; both still pointing to same location
...
// const{name, balance, age} = obj; // destructure property of obj name obj
// console.log(name, balance, age);
// we can also use destructing to update/changed the variales names 
...
const user = {
    ...
    getDetails: function () {
      return `Name: ${namex}, Age: ${age}`; // ` backticks 
    },
